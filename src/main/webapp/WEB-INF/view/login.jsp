            ...
            <div class="login-box">
                ...
                <form class="form-horizontal" action="/admin/login" method="post">
                    <fieldset>
                        ...
                        <div class="input-prepend" title="Password">
                            <span class="add-on"><i class="halflings-icon text-left"></i></span>
                            <input class="input-small span3" name="verification" id="login_code" type="text" placeholder=""/>
                            <img src="../verification" alt="" onclick="this.src='../verification?'+new Date().getTime()"></span><br>
                        </div>

                        <div class="clearfix"></div>

                        <label class="remember" for="remember"><input type="checkbox" id="remember" name="remember"/>记住我</label>
